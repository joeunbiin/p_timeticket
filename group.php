    ...
    <div id="wrap">
        ...
        <section id="grouppage">
            <div class="groupcontent">
                ...
                <div class="groupapp">
                    <img src="images/group.png" alt="타임티켓 단체관람">
                </div>
                <div class="groupbox">
                    <img src="images/group_1.png" alt="단체관람 혜택">
                    <img src="images/group_2.png" alt="단체관람 절차">
                    <img src="images/group_3.png" alt="기타 안내사항">
                    <ul>
                        <li>· 관람인원이 100명 이상인 경우, 정규 공연 시간 외 특별 공연 협의가 가능합니다.</li>
                        <li>· 당일 관람하지 못하는 인원이 발생하는 경우, 총 인원 수의 10% 내에서 부분환불/조정이 가능합니다.</li>
                    </ul>
                    <p><button type="button">문의/예약</button></p>
                </div>
            </div>
        </section>
