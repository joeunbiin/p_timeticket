                   ...
                   <div id="qna_list">
                        <table class="free_qna">
                            ...
                            <?php 
                                ...
                                $sql = "select * from mobqna order by num desc";
                                ...
                                <tr>
                                    <td><?= $number; ?></td>
                                    <td><a href="qna_view.php?num=<?=$num?>&page=<?=$page?>"><?=$subject?>
                                        <span>
                                        <?php 
                        ...
                        <div class="buttons">
                            <?php 
                                if($userid) {
                            ?>
                                <button onclick="location.href='qna_form.php'">글쓰기</button> <!-- 로그인 한 사람-->
                            <?php
                            } else {
                            ?>    
                                <button onclick="alert('로그인 후 이용해주세요!')">글쓰기</button> <!-- 로그인 안한 사람-->
                            <?php 
                            }
                            ?>
                        </div>
