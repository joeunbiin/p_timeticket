        ...
        <?php include 'header.php'; ?>
         ...
         <section class="noticepage">
            <div class="noticecontent">
                ...
                ?>
            <div class="noticebox">
                <form action="notice_modify.php?num=<?=$num?>&page=<?=$page?>" name="notice_form" method="post" enctype="multipart/form-data">
                <ul id="notice_form">
                        <li>
                            <span><input type="text" name="subject" id="irum" value="<?=$subject?>"></span>
                        </li>
                        <li>
