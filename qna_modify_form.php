         ...
         <section class="qnapage">
            <div class="qnacontent">
                <h2 class="pagetitle">
                    ...
                    1:1 문의 <i class="fas fa-chevron-right"></i> 글쓰기
                </h2>
                <?php 
                    $num = $_GET["num"];
                    $page = $_GET["page"];   
                ...
                ?>
            <div class="qnabox">
                <form action="qna_modify.php?num=<?=$num?>&page=<?=$page?>" name="qna_form" method="post" enctype="multipart/form-data">
                    <ul id="qna_form">
                        <li>
                            <span><input type="text" name="subject" id="irum" id="irum" value="<?=$subject?>"></span>
                        </li>
                        <li>
                            <span><textarea name="content" id="cont"><?=$content?></textarea></span>
                        </li>
                        <li>
